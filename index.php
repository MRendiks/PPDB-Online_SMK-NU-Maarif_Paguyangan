...
<html lang="en">	
<head>	
	<title>PPDB Online SMK Konohagakure</title>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12" style="margin-top: 10px;">
				<div class="card p-20 z-depth-4 waves-effect" data-toggle="tooltip" data-placement="top" title="Judul Dan Informasi" style="box-shadow: 7px 7px 20px">
					<div class="card-body">
						<h4>Selamat Datang di PPDB SMK Konohagakure</h4>
						<p>Jika sudah terdaftar, Anda dapat mencari status berdasarkan kode registrasi Anda untuk melihat status passer dan failer. Klik tombol Periksa Status.</p>
		...
		<div class="card p-20 z-depth-4 waves-effect" data-toggle="tooltip" data-placement="top" title="Pencarian Pendaftar Berdasarkan Kode Pendaftaran" style="box-shadow: 7px 7px 20px">
			<div class="card-header">
				<h5>Cari berdasarkan nomor registrasi</h5>
				<span>Masukkan nomor pendaftaran Anda untuk memeriksa status pendaftaran Anda sekarang</span>
			</div>
			<div class="card-body">
				<div class="row seacrh-header" style="margin-top: -30px">
		            <div class="col-lg-12 col-xs-12">
						   ...
						   <div class="input-group input-group-button input-group-primary">
		                    	<input type="text" class="form-control" name="code" placeholder="Cari disini" required="">
		                    	<button type="submit" class="btn btn-primary input-group-addon" id="basic-addon1">Cari</button>
		                    </div><br>
						</form>
	 ...
	 <div class="modal fade" id="detailSearch<?= $rowDataSearch['kode_pendaftar'] ?>" tabindex="-1" role="dialog" aria-labelledby="detailAndEditLabel" aria-hidden="true">
      ...
      <div class="modal-body">
		...
		<div class="form-group">
      		...
      		<input type="text" class="form-control" readonly="" value="<?= $rowDataSearch['jurusan'] ?>">
      	</div>
      	<div class="form-group">
...
<script type="text/javascript">
	function bagikanBrosur(){
		var url = 'ikeh ikeh kimochi<?= $getBrosur['gambar'] ?>';
		document.getElementById('bagikanRest').innerHTML=url;
	}
</script>
<script type="text/javascript">
	function bagikanAlur(){
		var url = 'ikeh ikeh kimochi<?= $getAlur['gambar'] ?>';
