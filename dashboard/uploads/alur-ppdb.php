<?php 
    ...
    require_once '../../src/dashboardFiles/alurUpload.php';
...
<body>
                    ...
                    <div class="pcoded-content">
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                <form method="post" action="" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <textarea name="deskripsi" id="inputEditor"></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <button type="submit" class="btn btn-success btn-round btn-sm" name="btnSubmit">Submit Data</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <p>Copyright &copy; 2022 by <a href="">Arif Widiarto</a></p>
                                </div>
    ...
    <!-- Ckeditor -->
    <script type="text/javascript" src="..\..\files\assets\pages\ckeditor\ckeditor2.js"></script>
