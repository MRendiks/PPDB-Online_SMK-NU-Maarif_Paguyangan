<?php 
	...
	if (isset($_POST['updateStatus']) === true) {
		...
		$queryUpdate = mysqli_query($link, "UPDATE status_pendaftaran SET status = '$ubah_status' WHERE kode_pendaftar = '$kode_pendaftar'");
		...
		if (mysqli_affected_rows($link) > 0) {
			echo "<script type='text/javascript'>
                        ...
                        window.location.replace('../verifikator');
                        } ,3000); 
                    </script>";
