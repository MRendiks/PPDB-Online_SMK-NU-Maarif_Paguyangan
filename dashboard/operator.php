                                                        ...
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="tableAdmin" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                   	<?php 
                                                                   		$no = 1;
                                                                   		$queryDetail = mysqli_query($link, "SELECT * FROM data_pendaftar INNER JOIN data_asal_sekolah ON data_pendaftar.kode_pendaftar = data_asal_sekolah.kode_pendaftar INNER JOIN status_pendaftaran ON data_pendaftar.kode_pendaftar = status_pendaftaran.kode_pendaftar WHERE status = 'pengecekan' OR status = 'tidak_valid' OR status = 'konfirmasi' OR status = 'verifikasi' ORDER BY data_asal_sekolah.nem DESC");
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                        	<a href="detail-operator/detail-operator.php?kode_pendaftar=<?= $rowData['kode_pendaftar'] ?>" class="btn btn-info btn-round btn-sm"><i class="feather icon-info"></i>Detail</a>  
