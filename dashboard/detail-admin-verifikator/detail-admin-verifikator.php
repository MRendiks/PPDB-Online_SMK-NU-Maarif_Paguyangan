<?php 
	...
	$kode_pendaftar = $_GET['kode_pendaftar'];
	$querySelectId = "SELECT * FROM data_pendaftar JOIN data_asal_sekolah ON data_asal_sekolah.kode_pendaftar = data_pendaftar.kode_pendaftar JOIN data_jurusan ON data_jurusan.kode_pendaftar = data_pendaftar.kode_pendaftar JOIN status_pendaftaran ON status_pendaftaran.kode_pendaftar = data_pendaftar.kode_pendaftar WHERE data_pendaftar.kode_pendaftar = '$kode_pendaftar' AND status = 'verifikasi'";
	...
	if (isset($_POST['updateStatus']) === true) {
        ...
        $ubah_jurusan = htmlspecialchars($_POST['ubah_jurusan']);
		$name = htmlspecialchars($fetchId['nama_lengkap']);
        // $jarak = htmlspecialchars($_POST['jarak']);

		$queryUpdate = mysqli_query($link, "UPDATE status_pendaftaran SET status = '$ubah_status', jurusan = '$ubah_jurusan' WHERE kode_pendaftar = '$kode_pendaftar'");
        // $queryUpdate = mysqli_query($link, "UPDATE data_alamat SET jarak = '$jarak' WHERE kode_pendaftar = '$kode_pendaftar'");
		...
		if (mysqli_affected_rows($link) > 0) {
			echo "<script type='text/javascript'>
                        ...
                        window.location.replace('../admin-verifikator');
                        } ,3000); 
                    </script>";
                                	...
                                	<div class="col-xl-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    ...
                                                    <span class="text-muted">Berikut ini adalah status <?= ucwords(strtolower($fetchId['nama_lengkap'])) ?> Anda bisa mengubah status nya saja, jika status data-data milik <?= $fetchId['nama_lengkap'] ?> itu <b>valid</b>, anda bisa memilih peserta itu <b>lulus atau tidak lulus</b> sesuai kriteria dari sekolah yang berlaku, kalau ada yang kurang valid Anda bisa memilih <b>Konfirmasi</b> sedangkan kalau data-data nya tidak valid ubah statusnya menjadi <b>Tidak Valid</b></span>
                                                ...
                                                <div class="card-block">
                                                	<form method="post" action="">
                                                        ...
                                                        <div class="form-group">
                                                			...
                                                			<select name="ubah_jurusan" id="ubah_jurusan" class="form-control" required="">
                                                				<option>---Pilih---</option>
                                                        ...
                                                        <!-- <div class="form-group">
                                                            Berikut adalah alamat url google maps <?= $fetchId['nama_lengkap'] ?> <b><a href="<?= $fetchId['url'] ?>"><?= $fetchId['url'] ?></a></b>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="jarak">Jarak</label>
                                                            <input type="text" class="form-control" name="jarak" value="<?php if($fetchId['jarak'] === ''){
                                                                echo 'Data kosong, Silahkan isi untuk mengukur jarak';
                                                            }else{
                                                                echo $fetchId['jarak'];
                                                            } ?>" required>
                                                        </div> -->
                                                		...
                                                		<div class="form-group">
                                                			<button type="submit" name="updateStatus" id="updateStatus" class="btn btn-success btn-round btn-sm" onclick="return confirm('Apakah anda yakin ingin mengubah status data <?= $fetchId['nama_lengkap'] ?>')">Ubah</button>
                                                		</div>
                                                	</form>
                                                </div>
                                            </div>
                                	 ...
                                	 <div class="col-xl-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    ...
                                                    <span class="text-muted">Berikut ini adalah kumpulan data-data <?= ucwords(strtolower($fetchId['nama_lengkap'])) ?> Anda hanya bisa mengubah status dan mengukur jarak, jika status data-data milik <?= $fetchId['nama_lengkap'] ?> itu valid, anda bisa pilih status verifikasi, kalau tidak valid ubah statusnya menjadi Tidak Valid</span>
                                                    <div class="card-header-right">
                                                        <ul class="list-unstyled card-option">
                                                           	<li><i class="feather icon-maximize full-card"></i></li>
                                                            <li><i class="feather icon-minus minimize-card"></i></li>
                                                ...
                                                <div class="card-block">
                                             		...
                                             		<div class="form-group">
                                             			<label for="alamat_sekolah">NPSN Sekolah</label>
                                             			<input type="text" class="form-control" value="<?= $fetchId['npsn_sekolah'] ?>" readonly>
                                             		</div>
                                             		<div class="form-group">
