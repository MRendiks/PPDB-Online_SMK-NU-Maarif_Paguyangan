                                	 ...
                                	 <div class="col-xl-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    ...
                                                    <span class="text-muted">Berikut ini adalah kumpulan data-data <?= ucwords(strtolower($fetchId['nama_lengkap'])) ?></span>
                                                ...
                                                <div class="card-block">
                                                     ...
                                                     <div class="form-group">
                                             			<label for="nama_lengkap">NIS</label>
                                             			<input type="text" class="form-control" value="<?= $fetchId['nis'] ?>" readonly="">
                                             		</div>
                                                     <div class="form-group">
                                             			<label for="nama_lengkap">NISN</label>
