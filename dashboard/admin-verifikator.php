...
<body>
                                                        ...
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="tableAdmin" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                   	<?php 
                                                                   		$no = 1;
                                                                   		$queryDetail = mysqli_query($link, "SELECT * FROM data_pendaftar JOIN data_asal_sekolah ON data_pendaftar.kode_pendaftar = data_asal_sekolah.kode_pendaftar JOIN status_pendaftaran ON data_pendaftar.kode_pendaftar = status_pendaftaran.kode_pendaftar WHERE status = 'verifikasi'");
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                        	<a href="detail-admin-verifikator/detail-admin-verifikator.php?kode_pendaftar=<?= $rowData['kode_pendaftar'] ?>" class="btn btn-info btn-round btn-sm"><i class="feather icon-info"></i>Detail</a> | 
    ...
    <div class="modal-dialog " role="document">
        ...
        <div class="modal-body">
            <form action="" method="post">
                <div class="form-group">
                    <label for="nama_jurusan">Nama Jurusan <font color="red">*</font></label>
                    <input type="text" name="nama_jurusan" id="nama_jurusan" class="form-control" 
                    required autofocus autocomplete="off" minlength="4" placeholder="Masukkan nama jurusan">
                </div>
        </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
